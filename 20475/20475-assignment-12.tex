...
נרצה להפריד לצורת $\frac{a}{t-(\sqrt{2}-1)} + \frac{b}{t-(\sqrt{2}+1)}$.
\begin{align*}
    \frac{1}{t^2+2t-1}=\frac{a}{t-(\sqrt{2}-1)} + \frac{b}{t-(\sqrt{2}+1)} \\
    1=a(t-(\sqrt{2}+1)+b(t-(\sqrt{2}-1))                                   \\
\end{align*}
נשווה מקדמים של איברי הפולינום:
\[
    \begin{cases}
        [1]: 1=a(1-\sqrt{2})+b(1+\sqrt{2}) \\
        [t]: 0=a+b \; \Rightarrow b=-a
    \end{cases}
\]
\begin{align*}
    1=a(1-\sqrt{2})-a(1+\sqrt{2}) = a-\sqrt{2}a-a-\sqrt{2}a=-2\sqrt{2}a \\
\end{align*}

נקבל $a=-\frac{1}{2\sqrt{2}}, b=\frac{1}{2 \sqrt{2}}$, סך הכל
\[
    2 \int_1^{\sqrt{2}+1} \frac{dt}{t^2+2t-1} =
    \frac{1}{\sqrt{2}} \int_1^{\sqrt{2}+1} (\frac{1}{t-(\sqrt{2}+1)} + \frac{1}{t-(\sqrt{2}-1)})dt=
\]
\[
    \frac{1}{\sqrt{2}} \cdot \ln(\frac{t-(\sqrt{2}+1)}{t-(\sqrt{2}-1)})\bigg|_1^{\sqrt{2}+1}=
    \frac{1}{\sqrt{2}} ()
\]
